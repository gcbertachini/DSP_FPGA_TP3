...
bpFilt = designfilt('bandstopiir','FilterOrder',6, 'HalfPowerFrequency1',fhp1,'HalfPowerFrequency2',fhp2, ...
        'SampleRate',1);
...
W=linspace(0,pi,3000);		%genera un vector de 3000 puntos e																																									
																						%																						jw
[H,W]=freqz(h,W);   		%calculo el vector H(ejwt)
